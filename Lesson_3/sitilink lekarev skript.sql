...
-- Table `mydb`.`Magazin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Magazin` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Zakaz` (
  ...
  CONSTRAINT `fk_Zakaz_Magazin1`
    ...
    REFERENCES `mydb`.`Magazin` (`id_Magazina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`categorias_dostavki` (
...
-- Table `mydb`.`dostavka`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`dostavka` (
  ...
  CONSTRAINT `fk_dostavka_Zakaz1`
    ...
    REFERENCES `mydb`.`Zakaz` (`id_Zakaza`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dostavka_categorias_dostavki1`
    FOREIGN KEY (`id_categorias_dostavki`)
    REFERENCES `mydb`.`categorias_dostavki` (`id_categorias_dostavki`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`categorias_tovars` (
...
-- Table `mydb`.`tovars`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tovars` (
  ...
  CONSTRAINT `fk_tovars_categorias_tovars1`
    ...
    REFERENCES `mydb`.`categorias_tovars` (`id_careporias_tovars`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`doljnoctii` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Sotrudniki` (
  ...
  CONSTRAINT `fk_Sotrudniki_doljnoctii1`
    ...
    REFERENCES `mydb`.`doljnoctii` (`id_Doljnosti`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Zakaz_has_tovars` (
  `id_Zakaza` INT NOT NULL,
  `id_tovara` INT NOT NULL,
  ...
  CONSTRAINT `fk_Zakaz_has_tovars_tovars1`
    ...
    REFERENCES `mydb`.`tovars` (`id_tovara`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
